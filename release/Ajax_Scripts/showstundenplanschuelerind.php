...
$semester = $_GET['k'];
 ...
 $isEntryLM= "Select * From sv_LernendeModule where User_ID='$uid'";

    $resultLM = mysqli_query($con, $isEntryLM);

    while( $vLM= mysqli_fetch_array($resultLM)) {
        $sid=$vLM['ID'];
...
$isEntryLK= "Select * From sv_LernendeModule where ID='$sid' ";

    $resultLK = mysqli_query($con, $isEntryLK);

    while( $valueCheck1= mysqli_fetch_array($resultLK)) {
    ...
    $isEntry = "Select * From $KurseDB Where (Klasse='$Klasse1' or Klasse='$Klasse2' or Klasse='$Klasse3' or Klasse='$Klasse4' or Klasse='$Klasse5' or Klasse='$Klasse6' or Klasse='$Klasse7' or Klasse='$Klasse8' or Klasse='$Klasse9' or Klasse='$Klasse10' or Klasse='$Klasse11' or Klasse='$Klasse12') and Tag='$Tag' ";
...
$isEntryLK= "Select * From sv_LernendeModule where ID='$sid' ";
    ...
    $isEntry = "Select * From $KurseDB Where (Klasse='$Klasse1' or Klasse='$Klasse2' or Klasse='$Klasse3' or Klasse='$Klasse4' or Klasse='$Klasse5' or Klasse='$Klasse6' or Klasse='$Klasse7' or Klasse='$Klasse8' or Klasse='$Klasse9' or Klasse='$Klasse10' or Klasse='$Klasse11' or Klasse='$Klasse12')  ORDER BY Startdatum ASC";
$result = mysqli_query($con, $isEntry);
$y=0;
$KursIDarr= array();
