...
$sql_befehl="Insert Into sv_Zeugnisse (Vorname,Nachname,Geburtstag,Geburtsort,Verhalten,Mitarbeit,Klassenziel,Bemerkung,Datum,Zwischenzeugnis,SchuelerID,Klasse,Schuljahr,Fach1,Note1,Fach2,Note2,Fach3,Note3,Fach4,Note4,Fach5,Note5,Fach6,Note6,Fach7,Note7,Fach8,Note8,Fach9,Note9,Fach10,Note10,Fach11,Note11,Fach12,Note12) VALUES  ('$Vorname','$Nachname','$Geburtstag','$Geburtsort','$Verhalten','$Mitarbeit','$Klassenziel','$Bemerkung','$Datum','$Zwischenzeugnis','$SchuelerID','$Klasse','$Schuljahr','$Kurs1','$Note1','$Kurs2','$Note2','$Kurs3','$Note3','$Kurs4','$Note4','$Kurs5','$Note5','$Kurs6','$Note6','$Kurs7','$Note7','$Kurs8','$Note8','$Kurs9','$Note9','$Kurs10','$Note10','$Kurs11','$Note11','$Kurs12','$Note12')";	
...
$templateProcessor->setValue('Geburtstag', $Geburtstag);
