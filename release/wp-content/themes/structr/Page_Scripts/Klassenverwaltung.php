...
<body>
	...
	<div id="myModal2" class="modal">
		...
		<div class="modal-content4">
			...
			<form action="/DBFuellung/DBFuellungSchuelereingabeErw.php " method="POST">
				...
				<br> Bestehende Klasse wählen:<br/>
	...
	<div id="myModal3" class="modal1">
		...
		<div class="modal-content3">
			...
			<br> zu bearbeitende Klasse wählen:<br/>
...
//				echo "<option>Alle Schüler (unabhängig von der Klasse)</option>";
	...
	<div id="myModal4" class="modal1">
		...
		<div class="modal-content2">
			...
			<form action="/DBFuellung/DBFuellungSchuelereingabeKopie.php " method="POST">
				<br>
				<h2><strong>Klasse kopieren</strong></h2> zu kopierende Klasse wählen:<br/>
	...
	<div id="myModal5" class="modal1">
		...
		<div class="modal-content1">
			...
			<br>
			<h2><strong>Klasse löschen</strong></h2> zu löschende Klasse wählen:
			...
			?>
			<input name="Senden" type="button" value="Weiter" onclick="deleteclass()"/><br/>
			<hr/>
	...
	<div id="myModal6" class="modal1">
		...
		<div class="modal-content1">
			...
			<br>
			<h2><strong>Klasse wiederherstellen</strong></h2> zu wiederherstellende Klasse wählen:
			...
			?>
			<input name="Senden" type="button" value="Weiter" onclick="recoverclass()"/><br/>
			<hr/>
