...
PRODID://Drupal iCal API//EN';
    ...
    if ($KlasseInput <> "" and $userID==1000000) {
...
SUMMARY:'.$line2['Eventname'] . " Klasse: " . $line2['Klasse'] .'
LOCATION:'. "Zimmer:" .$line2['Zimmer'].'
DESCRIPTION:'.$line2['Eventname'] . " Klasse: " . $line2['Klasse'] .'
END:VEVENT';
        }
...
$body             = "Hier Ihre Klassentermine fuer den Outlook Kalender. Fuehren Sie die Datei im Anhang aus, um Ihre Klassentermine dem Outlook Kalender hinzuzufuegen.";
...
$mail->Subject    = "Schulverwaltungssystem - Ihre Klassentermine";

$mail->AltBody    = "Schulverwaltungssystem - Ihre Klassentermine"; // optional, comment out and test
...
$mail->addStringAttachment($ical_content,'Klassentermine.ics','base64','text/calendar');
