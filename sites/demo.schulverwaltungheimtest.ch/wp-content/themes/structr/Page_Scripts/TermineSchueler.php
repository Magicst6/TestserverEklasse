    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var calendar = $('#calendar').fullCalendar({
                ...
                events:  "/wp-content/themes/structr/Page_Scripts/GetTerminValues.php?q="+ document.getElementById('curruser').value,
...
<table class="timecard"  border="0">
  ...
  <tbody>
	...
	<tr>
      ...
      <td> <input type="text" name="klasse" id="klasse" value="" class="text ui-widget-content ui-corner-all" readonly></td>
    </tr>
