...
$klasseTab="sv_KurseAll".$Klasse;
		...
		$updateKALL = "UPDATE $klasseTab SET LP_ID = '', Lehrperson = '' where LP_ID='$Lehrer'	";
...
$klasseTab="sv_KurseAll".$Klasse;
					...
					$updateKALL1 = "UPDATE $klasseTab SET LP_ID = '$Lehrer', Lehrperson = '$Lehrperson'  where KursID ='$wert' ";
