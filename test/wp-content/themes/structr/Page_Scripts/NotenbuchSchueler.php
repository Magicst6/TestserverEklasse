...
function tableshow(){
	var new_url1= "/wp-content/themes/structr/Page_Scripts/GetNotenValuesSchueler.php?k="+document.getElementById("hidschueler").value;
			
		
	table.ajax.url( new_url1 ).load();
}		
...
<div id="lernende"><b>Unten die Noten der Kursteilnehmer...</b><br><br></div>
