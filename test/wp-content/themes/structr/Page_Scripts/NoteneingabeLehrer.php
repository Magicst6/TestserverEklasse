...
if ($_GET['Kursname']==null and $_GET['Schuler']==null )
{
	 echo "<option></option>";
}
if($_GET['Schueler']==null and $_GET['Kursname']<>null ) {
 echo "<option>" . "-Select-". "</option>";
		}
   if($_GET['Schueler']<>null and $_GET['Kursname']<>null  ){
    ...
    <div class="modal-content">
        <form action="/DBFuellung/DBFuellungLernenderKurs.php "method="POST">
           ...
           ?>
            ...
            <p>Bitte hier die Note eintragen oder bearbeiten..</p>
