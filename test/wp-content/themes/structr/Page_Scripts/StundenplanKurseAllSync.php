...
while( $valueStundenplan= mysqli_fetch_array($resultStundenplan)) {
  ...
  $time= null;
    ...
    if ($time<>null) {
        ...
        if (!$isExisting){
            $sql_befehl = "INSERT INTO sv_KurseAll (Kursname, KursID, Tag, Klasse, LP_ID,Datum, Start, Ende, Lehrperson,Farbe ) VALUES ('$Kursname','$KursID','$Tag','$Klasse','$LP_ID','$Datum','$Start','$End','$Lehrperson','$Farbe')";
...
// In die DB-Tabelle eintragen
        ...
        for ($x = 0; $x < $y; $x++) {
            ...
            if (!$isExisting){
                $sql_befehl = "INSERT INTO sv_KurseAll (KursID, Tag, Klasse, LP_ID,Datum, Start, Ende, Lehrperson,Farbe ) VALUES ('$KursID','$Tag','$Klasse','$LP_ID','$Datum','$Start','$End','$Lehrperson','$Farbe')";
