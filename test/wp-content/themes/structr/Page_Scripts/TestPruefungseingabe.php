...
*/
...

                {
                    ...
                    xmlhttp.open("GET", "/Ajax_Scripts/showschuelernoten.php?f=" + event.klasse + "&g=" + event.kursid +"&h=" + startdate +"&i=" + event.title  + "&j=" + starttime+  "&k=" + enddate + "&l=" + endtime + "&m=" + event.zimmer + "&n=" + event.kursname+  "&o=" + event.lehrperson+ "&p=" + event.color + "&q=" + event.gewichtung , true);
