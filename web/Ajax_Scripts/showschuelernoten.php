...
<form action=" https://schulverwaltungheimtest.ch/DBFuellung/DBFuellungNoten.php" method="POST">
...
?>
 ...
 <fieldset>
     ...
     <input type="text" name="gewicht" id="gewicht" value="<?php echo $_GET['q'];?>" class="text ui-widget-content ui-corner-all" readonly>
     ...
     <br>
            ...
            <input type="text" name="farbe" id="farbe" value="<?php echo $_GET['p'];?>" class="text ui-widget-content ui-corner-all" readonly >
	...
	<?php
	 $Pruefungsname=$_GET['i'];
	  $isEntry = "SELECT Kommentar From sv_Pruefungen Where Pruefungsname='$Pruefungsname' and Datum='$datum' and KursID='$Kursnme' ";
...
if ($Kursnme<>'' && $Kursnme<>"-Select-") {
    ...
    while ($value1 = mysqli_fetch_array($result)) {
        ...
        $Profil = $value1['Profil'];
            ...
            $isEntry1 = "SELECT Note6, Datum6,SchülerID From sv_LernenderKurs Where Name1='$Pruefungsname' and KursID='$Kursnme'  ";
