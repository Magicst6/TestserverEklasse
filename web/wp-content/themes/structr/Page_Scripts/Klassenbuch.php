<script>
    function getKursname(str){
        ...
        if (str == "") {
            ...
            xmlhttp.open("GET","https://wios.eklasse.ch/Ajax_Scripts/getKursnameLehrer.php?q="+str,true);
            xmlhttp.send();
        }
    }
    function test(str){
        if (str == "") {
            ...
            xmlhttp.open("GET","https://wios.eklasse.ch/Ajax_Scripts/showlernendeLehrer.php?q="+str+"&k="+document.getElementById("lehrer").value+"&h="+document.getElementById("date").value,true);
            xmlhttp.send();
        }
    }
    function testdate(str){
        if (str == "") {
            ...
            xmlhttp.open("GET","https://wios.eklasse.ch/Ajax_Scripts/showlernendeLehrer.php?q="+document.getElementById("Kursnm").value+"&k="+document.getElementById("lehrer").value+"&h="+str,true);
            xmlhttp.send();
        }
    }
...
while( $line2= mysqli_fetch_assoc($result))
{
    ...
    echo '<form action=" http://wios.eklasse.ch/DBFuellung/DBFuellungKlbu.php" method="POST">';
