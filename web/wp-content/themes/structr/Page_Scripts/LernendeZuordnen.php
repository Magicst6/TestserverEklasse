    ...
    <script type='text/javascript'>
        ...
        function zuordnen(lernender,login){
            if (lernender == "" || login == "") {
                ...
                xmlhttp.open("GET","https://schulverwaltungheimtest.ch/Ajax_Scripts/lernendezuordnenscr.php?q="+lernender+"&h="+login,true);
                xmlhttp.send();
            }
        }
        function myFunction3(){
            window.location.href = "https://schulverwaltungheimtest.ch/lernende-automatisch-zuordnen";
        }
