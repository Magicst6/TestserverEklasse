...
?>
    ...
    <select id="schueler" name="schueler" onchange="myFunction()">
   ...
   <?php
    ...
    $isEntry= "Select Name,Vorname,Klasse From sv_Lernende WHERE ID='$value'";
...
<br>
    ...
    <script type='text/javascript'>
        ...
        function myFunction(){ var x = ""; var y = document.querySelector("#schueler").value; window.location.href = "meine-abwesenheiten?&Kursname="+x+"&schueler="+y; }

        function myFunction1(){ var x = document.querySelector("#Kursname").value; var y = document.querySelector("#schueler").value; window.location.href = "meine-abwesenheiten?&Kursname="+x+"&schueler="+y; }
    ...
    <select id="Kursname" name="Kursname" required="required" onchange="myFunction1()">
