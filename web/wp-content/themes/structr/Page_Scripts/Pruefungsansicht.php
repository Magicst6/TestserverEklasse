...
<head>
    ...
    <script>
            ...
            function reload() {
                ...
                window.location.href = "https://schulverwaltungheimtest.ch/pruefungen-verwaltung?&klasse=" + x + "&Lehrpersondr=" + y;
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var calendar = $('#calendar').fullCalendar({
                ...
                events:  "https://schulverwaltungheimtest.ch/wp-content/themes/structr/Page_Scripts/GetPruefterminValues.php?q="+ document.getElementById('curruser').value + "&k="+ document.getElementById('klassedrop').value + "&l="+ document.getElementById('Lehrpersondrop').value,
                        ...
                        dialog = $("#dialog-form").dialog({
                            ...
                            buttons: {
                                ...
                                "Speichern":function()  {
                                    ...
                                    xmlhttp.open("GET", "https://schulverwaltungheimtest.ch/wp-content/themes/structr/Page_Scripts/insertPrueftermin.php?q=" + title.val() + "&k=" + startCustdate.val() + "T" + startCusttime.val() + "&g=" + endCustdate.val() + "T" + endCusttime.val()+ "&klasse=" + document.getElementById('klasse').value + "&kursid=" + document.getElementById('kursid').value + "&kursname=" + document.getElementById('kursname').value + "&color=" + document.getElementById('farbe').value + "&zimmer=" + document.getElementById('zimmer').value + "&l=" + document.getElementById('lehrperson').value +  "&gewichtung=" + document.getElementById('gewicht').value, true);
                ...
                eventResize:function(event) {
                    ...
                    xmlhttp.open("GET", "https://schulverwaltungheimtest.ch/wp-content/themes/structr/Page_Scripts/updatePruefterminDrop.php?k=" + start + "&g=" + end + "&f=" + id, true);
                            ...
                            "Speichern": function(){
                             ...
                             "Löschen":function(){
                                ...
                                if(confirm("Are you sure you want to remove it?")) {
                                     ...
                                     xmlhttp.open("GET", "https://schulverwaltungheimtest.ch/wp-content/themes/structr/Page_Scripts/deletePrueftermin.php?f=" + id, true);
    ...
    <script>
        ...
        function addUser() {
            ...
            xmlhttp.open("GET", "https://schulverwaltungheimtest.ch/wp-content/themes/structr/Page_Scripts/insertPrueftermin.php?q=" + title.val() + "&k=" + startCustdate.val() + "T" + startCusttime.val() + "&g=" + endCustdate.val() + "T" + endCusttime.val()+ "&klasse=" + document.getElementById('klasse').value + "&kursid=" + document.getElementById('kursid').value + "&kursname=" + document.getElementById('kursname').value + "&farbe=" + document.getElementById('farbe').value + "&zimmer=" + document.getElementById('zimmer').value+ "&lehrperson=" + document.getElementById('lehrperson').value +"&gewichtung=" + document.getElementById('gewicht').value, true);
...
<div id="dialog-form" title="Termin">
    ...
    <form>
       ...
       <fieldset>
            ...
            <input type="text" name="title" id="title" value="" width="400px" ">
            ...
            <input type="time" name="endtime" id="endtime" value="" class="text ui-widget-content ui-corner-all" >
             ...
             <input type="text" name="gewicht" id="gewicht" value="" class="text ui-widget-content ui-corner-all"  >
...
<script>
    function Mail(){
        ...
        xmlhttp.open("GET","https://schulverwaltungheimtest.ch/wp-content/themes/structr/Page_Scripts/GetPruefterminValuesMail.php?q="+ document.getElementById('curruser').value + "&k="+ document.getElementById('klassedrop').value + "&l="+ document.getElementById('Lehrpersondrop').value + "&m="+ document.getElementById('Mail').value,true);
