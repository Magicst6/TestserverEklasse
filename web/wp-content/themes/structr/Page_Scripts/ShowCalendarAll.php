...
<head>
    ...
    <input type="hidden" name="curruser" id="curruser" value="1000000" class="text ui-widget-content ui-corner-all" readonly >
...
<div class="outer" style="width:1500px;">
