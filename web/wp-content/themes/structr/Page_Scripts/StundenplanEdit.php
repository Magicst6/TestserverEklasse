<form action="https://schulverwaltungheimtest.ch/DBFuellung/DBFuellungStundenplan.php" method="POST">
    ...
    <script>
        function getKlasse(str){
            if (str == "") {
                ...
                xmlhttp.open("GET","https://schulverwaltungheimtest.ch/Ajax_Scripts/showstundenplan.php?q="+document.getElementById("klasse").value +"&k="+document.getElementById("semester").value,true);
                xmlhttp.send();
            }
        }
    </script>
