...
<script type='text/javascript'>
    function myFunction(){
        var x = ""; var y = document.querySelector("#Semester").value; window.location.href = "stundenplaene-archiv?&Semester="+y;
    }
</script>
...
<script>
    function getKlasse(str){
        if (str == "") {
            ...
            xmlhttp.open("GET","https://schulverwaltungheimtest.ch/Ajax_Scripts/showstundenplanschueler_Archiv.php?q="+document.getElementById('klasse').value+"&k=" + document.getElementById('Semester').value,true);
            xmlhttp.send();
        }
    }
</script>
