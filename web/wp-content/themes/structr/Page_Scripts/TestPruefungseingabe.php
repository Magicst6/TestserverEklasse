...

{
    ...
    echo '<form action=" https://schulverwaltungheimtest.ch/DBFuellung/DBFuellungKlbu.php" method="POST">';
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var calendar = $('#calendar').fullCalendar({
                ...
                events:  "https://schulverwaltungheimtest.ch/wp-content/themes/structr/Page_Scripts/GetPruefterminValues.php?q="+ document.getElementById('curruser').value,
...
*/
...

                {
                    ...
                    xmlhttp.open("GET", "https://schulverwaltungheimtest.ch/Ajax_Scripts/showschuelernoten.php?f=" + event.klasse + "&g=" + event.kursid +"&h=" + startdate +"&i=" + event.title  + "&j=" + starttime+  "&k=" + enddate + "&l=" + endtime + "&m=" + event.zimmer + "&n=" + event.kursname+  "&o=" + event.lehrperson+ "&p=" + event.color + "&q=" + event.gewichtung , true);
